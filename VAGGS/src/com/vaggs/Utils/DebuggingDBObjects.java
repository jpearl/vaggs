	...
	public static void createDBObjects () {
		...
		Taxiway taxiway = new Taxiway('B'); 
		 taxiway.setWaypoints(Arrays.asList(
			new Waypoint(new LatLng(41.73228367493647, -71.42739772796631), false, false),
			new Waypoint(new LatLng(41.72972153234874, -71.42662525177002), false, false),
			new Waypoint(new LatLng(41.72853650684023, -71.42628192901611), false, false),
			new Waypoint(new LatLng(41.727479573755126, -71.42520904541016), false, false),
			new Waypoint(new LatLng(41.726678855296136, -71.42430782318115), true, false),
			...
			new Waypoint(new LatLng(41.722707144234306, -71.42400741577148), false, false)
			));
		...
		new Waypoint(new LatLng(41.7312588301645, -71.42203330993652), false, false),
		new Waypoint(new LatLng(41.73074640164693, -71.42087459564209), true, false)
			));
		taxiways.add(taxiway);
		...
		new Waypoint(new LatLng(41.725205507257044, -71.42696857452393), false, false),
		new Waypoint(new LatLng(41.72453288061494, -71.42598152160645), true, false), 
		new Waypoint(new LatLng(41.722707144234306, -71.42400741577148), false, false),
		new Waypoint(new LatLng(41.71783826026642, -71.41907215118408), false, false), 
		new Waypoint(new LatLng(41.718414857887055, -71.41825675964355), true, false)
			));
		taxiways.add(taxiway);
		...
		taxiway = new Taxiway('E'); 
		 taxiway.setWaypoints(Arrays.asList(
		new Waypoint(new LatLng(41.719536005117995, -71.43555164337158), false, false),
		new Waypoint(new LatLng(41.71610843636524, -71.43426418304443), false, false)
				));
		taxiways.add(taxiway);
		...
		new Waypoint(new LatLng(41.73151504289037, -71.43237590789795), false, false)
		));
		 taxiways.add(taxiway);
		 ...
		 taxiway.setWaypoints(Arrays.asList(
		new Waypoint(new LatLng(41.7312588301645, -71.42203330993652), false, false),
		new Waypoint(new LatLng(41.729849641905204, -71.42327785491943), false, false),
		new Waypoint(new LatLng(41.727479573755126, -71.42520904541016), false, false),
		new Waypoint(new LatLng(41.72626247775354, -71.42602443695068), true, false), 
		new Waypoint(new LatLng(41.725205507257044, -71.42696857452393), false, false)
		));
		 taxiways.add(taxiway);
		...
		new Waypoint(new LatLng(41.72869664669985, -71.43306255340576), false, false),
		new Waypoint(new LatLng(41.729561395043916, -71.43237590789795), false, false),
		new Waypoint(new LatLng(41.72972153234874, -71.4296293258667), true, false), 
		new Waypoint(new LatLng(41.72972153234874, -71.42662525177002), false, false), 
		new Waypoint(new LatLng(41.729849641905204, -71.42327785491943), false, false),
		new Waypoint(new LatLng(41.72988166925439, -71.42160415649414), true, false)
		 ));
		 taxiways.add(taxiway);
		 ...
		 taxiway.setWaypoints(Arrays.asList( 
		new Waypoint(new LatLng(41.71796639351807, -71.4325475692749), false, false), 
		new Waypoint(new LatLng(41.71610843636524, -71.43426418304443), false, false), 
		new Waypoint(new LatLng(41.714314495734975, -71.43537998199463), false, false),
		new Waypoint(new LatLng(41.713769896707845, -71.43443584442139), true, false)
		));
		 taxiways.add(taxiway);
		...
		new Waypoint(new LatLng(41.72056103689838, -71.43701076507568), false, false),
		new Waypoint(new LatLng(41.719536005117995, -71.43555164337158), false, false),
		new Waypoint(new LatLng(41.71796639351807, -71.4325475692749), false, false),
		new Waypoint(new LatLng(41.71754995951615, -71.43151760101318), true, false)
		));
		 taxiways.add(taxiway);
